...
<!--           <th>카드</th>
        ...
        <tr>
          ...
          <td><fmt:formatNumber type="number" pattern="###,###" value="${sum.total}" /> - <fmt:formatNumber type="number" pattern="###,###" value="${sum.cancel_card_sum + sum.refund_card_sum + sum.cancel_cash_sum + refund_cash_sum}" /></td>
          <td><fmt:formatNumber type="number" pattern="###,###" value="${sum.total - (sum.cancel_card_sum + sum.refund_card_sum + sum.cancel_cash_sum + refund_cash_sum)}" /></td>
        </tr>
        </c:if>
        </c:if>
      </table>
